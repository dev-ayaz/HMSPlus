...
namespace HMSPlus.DataAccess.Providers.Helpers
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        public IView<T> GetRepositoryForView<T>() where T : class
        {
            return (IView<T>)_repositoryFactories.GetRepositoryFactoryForView<T>()(DbContext);
        }

        private IView<T> GetView<T>(Func<DbContext, object> factory = null) where T : class
        {
